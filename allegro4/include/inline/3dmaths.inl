...
AL_FUNC(fixed, dot_product, (fixed x1, fixed y_1, fixed z1, fixed x2, fixed y2, fixed z2));

AL_FUNC(float, dot_product_f, (float x1, float y_1, float z1, float x2, float y2, float z2));

AL_FUNC(void, persp_project, (fixed x, fixed y, fixed z, fixed *xout, fixed *yout));
AL_FUNC(void, persp_project_f, (float x, float y, float z, float *xout, float *yout));
